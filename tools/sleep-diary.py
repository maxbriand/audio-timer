...
rows, from the short-lived dedicated button, are read the same way.)
...
def main():
    ...
    lines = [
        ...
        "",
        "| Night | Bedtime | SOL | Awakenings | WASO | Final wake | Rise | TIB | TST | SE | Fatigue | Morning light | 4wk TST | 4wk SE | Note |",
        "|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|",
    ]
    for n in nights:
