...
public class WakeActivity extends Activity {
  ...
  public void onBackPressed(){
    // Deliberately nothing: "I'm up" or Snooze are the only exits.
  }
  ...
  /* Stops the noise only — the notification is "I'm up"'s to cancel (or Snooze's), so an
  ...
  private void quiet(){
    ...
    nm.cancel(WakeAlarmReceiver.NOTIF_ID);
  }
